...
const breadcrumbConfig: Record<string, { name: string; icon: string; path?: string }> = {
  ...
  '/training/plans': { name: '训练计划制定', icon: '📋' },
  '/training/progress': { name: '进度跟踪', icon: '📈' },
  '/training/records': { name: '训练记录', icon: '📝' },
  '/training/strength': { name: '力量训练', icon: '🏋️‍♂️' },
  '/training/cardio': { name: '有氧训练', icon: '🏃‍♂️' },
