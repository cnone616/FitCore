...
const chestSubcategoryMap: Record<string, EquipmentCategory[]> = {
  'upper-chest': chestExerciseDataDetailed[0]?.equipmentCategories ?? [],
  'middle-lower-chest': chestExerciseDataDetailed[1]?.equipmentCategories ?? []
};
