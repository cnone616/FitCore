...
export const planOverview = {
  title: '健身房四分化(手臂强化)训练计划',
  description: '专注于手臂肌群的四分化训练计划，适合进阶训练者。Day1背+肩后束，Day2胸+肩前中束，Day3腿臀，Day4大臂+腹'
};

export const gym4SplitArmsPlans = [
  {
    dayId: 'day-1',
    dayName: 'Day1：背+肩后束',
    description: '为什么它们在一天练？因为练背会有肩伸（肩后束）、肩水平外展（肩后束），所以练背后接着继续用少量组数补练肩后束即可',
    trainingBlocks: {
  ...
  },
  {
    dayId: 'day-2',
    dayName: 'Day2：胸+肩前中束',
    description: '为什么它们在一天练？因为练胸会有肩屈（肩前束）、肩水平内收（肩前束），所以练胸后接着继续用少量组数补练肩前束即可',
    trainingBlocks: {
    ...
    additionalBlocks: {
      muscleGroupId: 'front-middle-deltoid',
      muscleGroupName: '肩前中束',
      exerciseCategories: [
        {
  ...
  },
  {
    dayId: 'day-4',
    dayName: 'Day4：大臂+腹',
    description: '专门的手臂训练日，针对肱二头肌和肱三头肌进行高强度训练',
    trainingBlocks: {
      muscleGroupId: 'bicep-training',
      muscleGroupName: '肱二头肌',
    ...
    additionalBlocks: {
      muscleGroupId: 'tricep-abs-training',
      muscleGroupName: '肱三头肌+腹部训练',
      exerciseCategories: [
        {
